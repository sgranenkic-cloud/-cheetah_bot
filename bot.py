...
def get_bot_token() -> str:
    ...
    token = "".join(token.split())  # removes spaces, tabs and newlines
...
WHERE_TRAININGS_TEXT = (
    ...
    "• Воскресенье 10:00 — совместная тренировка двух групп. Местро определяется тренером.\n"
...
def become_buttons() -> InlineKeyboardMarkup:
...
async def become(message: Message) -> None:
